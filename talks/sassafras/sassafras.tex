...
\begin{center} \includegraphics[width=0.8\textwidth]{ouroboros-png-1400.jpg} \end{center}
...
\hspace{10pt} the proof-of-work is a VRF with one input per time slot  \\ \smallskip
